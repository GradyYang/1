			...
			<div class="login-pad">
				<h2>Welcome to IT-Crowd System</h2>
					...
					<form action="signup2.php" method="post">
						<input type="text" name="fid" required = '' placeholder="ID                                                                                   	*">
						...
						<input type="text" name="faddress" placeholder="Address">
						<input type="text" name="fphone" required = '' placeholder="Phone                                                                            *">
						<input type="password" name="fpassword" required = '' placeholder="Password                                                                      *">
