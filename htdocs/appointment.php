			...
			<div class="login-pad">
				<h2>MAKE AN APPOINTMENT</h2>
					<form>
						...
						<input type="text" value="id" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'id';}" required="">
						  <td>2016
						  <select name="month">
						  ...
						  <td>
						  <select name="develop_ide[]" size="3" multiple id="develop_ide[]">
						  <option value="ZDE" selected>Dr.Zhang</option>
						  <option value="Eclipse">Dr.Wang</option>
						  <option value="Editplus">Dr.Liu</option>
						  <option value="Ultraedit">Dr.Li</option>
						  <option value="Other">Dr.Garrick</option>
						  <option value="Other">Dr.Jamie</option>
						  </select>
						  </td>
